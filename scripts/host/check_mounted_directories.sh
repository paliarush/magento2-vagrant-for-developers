...
cd "${vagrant_dir}"
#if [[ ! -f "/var/www/html/magento/composer.json" ]]; then
#    error "Directory '/var/www/html/magento' was not mounted as expected by Vagrant.
#        Please make sure that 'paliarush/magento2.ubuntu' Vagrant box was downloaded successfully (if not, this may help http://stackoverflow.com/questions/35519389/var/www/html-cannot-find-box)
